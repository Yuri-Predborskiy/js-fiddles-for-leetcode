 ...
 */
let copyRandomList = function(head) {
// todo: copy random list
    // 1st pass: for each node in linked list, add a duplicate node
    // 2nd pass: go over linked list (every 2nd node) and set random pointer to prev random.next
    // this will point new random pointers to new list nodes directly
};
